...
public class OtrasOperacionesJFrame extends JFrame {
	...
	public OtrasOperacionesJFrame() {
		...
		btnRecargaDeCelular.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
		...
		btnAsociacionTcCoord.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
		...
		btnRegistroCelular.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
		...
		button_3.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
		button_3.setHorizontalAlignment(SwingConstants.LEFT);
		button_3.setBounds(268, 118, 178, 29);
		contentPane.add(button_3);
		
		JButton button_4 = new JButton("IMPRESION DE RESUMEN");
		button_4.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
		button_4.setHorizontalAlignment(SwingConstants.LEFT);
		button_4.setBounds(268, 77, 178, 29);
		contentPane.add(button_4);
		
		JButton button_5 = new JButton("");
		button_5.setIcon(new ImageIcon("/Users/user/Pictures/shut-down.png"));
		...
		btnAltaSeguro.setIcon(new ImageIcon("/Users/user/Pictures/1307051141_737.png"));
